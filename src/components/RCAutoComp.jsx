...
export function RCAutoComp() {
  ...
  // Calcolo del preventivo vincente (quello con il premio finale più basso)
  ...
  return (
    <div style={{ maxWidth: 960, margin: '0 auto', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
              ...
              return (
                <button key={p.label} onClick={() => setCoperture(p)}
                  style={{
                    ...
                    color: active ? t.primary : '#475569', padding: '10px 14px', borderRadius: 12, fontWeight: 700, fontSize: 13, cursor: 'pointer', textAlign: 'left', lineHeight: 1.2,
      ...
      <div style={{
        ...
        }}>★ Le compagnie online più richieste</div>
        ...
        <p style={{ fontSize: 15, color: '#64748b', textAlign: 'center', marginBottom: 32, marginTop: 18, lineHeight: 1.6, maxWidth: 600, marginLeft: 'auto', marginRight: 'auto' }}>
          Due tra le assicurazioni dirette più scelte dagli italiani. Puoi generare un preventivo rapido sui loro siti e inserire i risultati nel calcolatore qui sopra.
        </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: 12, color: '#64748b', margin: '0 0 16px' }}>
              Preventivo calcolato in base alla tua targa
            </p>
            ...
            <div style={{
              ...
              {[
                { l: 'Polizza', v: 'Sospendibile', h: true },
                { l: 'Rivalsa', v: 'Rinunciabile', h: true },
                { l: 'Pagamento', v: 'Mensile/Annuo', h: false },
                { l: 'Assistenza', v: '24/7', h: false }
              ].map((item, i) => (
            ...
            <a href="https://www.financeads.net/tc.php?t=82784C5581131019T"
              ...
              }}>Fai un preventivo su Prima.it →</a>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              background: '#0284c7', color: '#fff', fontSize: 10, fontWeight: 800,
              textTransform: 'uppercase', padding: '4px 10px', borderRadius: 20,
              display: 'inline-block', marginBottom: 12, letterSpacing: '0.08em'
            }}>Sconto Satellitare</div>

            <div style={{ fontSize: 11, color: '#64748b', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 4 }}>
              ConTe.it (Gruppo Admiral)
            </div>
            <h3 style={{ fontSize: 22, fontWeight: 900, color: '#0f172a', margin: '0 0 6px', fontFamily: "'DM Serif Display', 'Playfair Display', serif" }}>
              Polizza ConTe
            </h3>
            ...
            <div style={{
              ...
              {[
                { l: 'Scatola Nera', v: 'Opzionale', h: false },
                { l: 'Sconto Sat', v: 'Fino 25%', h: true },
                { l: 'Assistenza', v: 'Satellitare', h: true },
                { l: 'Pagamento', v: 'Frazionabile', h: false }
              ].map((item, i) => (
                <div key={i} style={{ background: '#fff', padding: '10px 12px', textAlign: 'center' }}>
                  <div style={{ fontSize: 10, color: '#64748b', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 2 }}>{item.l}</div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: item.h ? '#16a34a' : '#0f172a' }}>{item.v}</div>
            ...
            <a href="https://www.financeads.net/tc.php?t=82784C5581131019T"
              target="_blank" rel="noopener noreferrer sponsored nofollow"
              style={{
                display: 'block', background: '#0284c7', color: '#fff',
                padding: '12px', borderRadius: 10, fontWeight: 800, fontSize: 13,
                textDecoration: 'none', textAlign: 'center'
              }}>Fai un preventivo su ConTe.it →</a>
          </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 11, color: '#64748b', margin: 0, lineHeight: 1.6 }}>
            <strong style={{ color: '#0f172a' }}>Trasparenza commerciale.</strong> Questa sezione contiene link di affiliazione: se calcoli un preventivo o acquisti una polizza attraverso i nostri collegamenti, potremmo ricevere una commissione dalla compagnia senza alcun ricarico sul tuo premio finale.
            L'inserimento in questa sezione è a scopo puramente esemplificativo tra le opzioni del mercato diretto. Verifica sempre la documentazione precontrattuale (DIP) sul sito della singola compagnia assicurativa per massimali, franchigie e limitazioni prima dell'acquisto.
          </p>
        </div>
      </div>

  ...
  return (
    <div style={{ maxWidth: 960, margin: '0 auto', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div style={{
        ...
        <p style={{ margin: '0 0 8px' }}>
          <strong>Parametri aggiornati al 2026.</strong> Soglie di accesso al forfettario (€85.000), cessazione immediata (€100.000), soglia reddito dipendente (€35.000), aliquota startup 5% per 5 anni, imposta sostitutiva 15%, scaglioni IRPEF 23%/35%/43%, Gestione Separata INPS 26,07%, minimale contributivo stimato €4.208. Verifica sempre i valori correnti sul sito dell'Agenzia delle Entrate e dell'INPS: la Legge di Bilancio di ciascun anno può modificarli.
        </p>
        <p style={{ margin: '0 0 8px' }}>
